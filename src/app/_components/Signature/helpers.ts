export function getUppercaseSVG(letter: string): string {
  ...
  export function getLowercaseSVG(letter: string): string {
    const svgs: Record<string, string> = {
  ...
  export function applyLetterMargins(element: HTMLElement, letter: string, isUppercase: boolean) {
