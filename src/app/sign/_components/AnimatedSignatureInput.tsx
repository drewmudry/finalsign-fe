...
export function SignatureInput({
  ...
  const getAnimationSpeed = () => {
    switch (animationSpeed) {
      case 'slow': return { typing: 120, stroke: 800 }
      case 'fast': return { typing: 50, stroke: 200 }
      default: return { typing: 80, stroke: 400 }
    }
  }
  ...
  useEffect(() => {
    ...
    const startAutoType = () => {
      ...
      const typeNextCharacter = () => {
        if (currentIndex < autoType.length) {
          const nextChar = autoType[currentIndex]
    ...
    startAutoType()
  }, [autoType, autoTypeDelay, onSignatureComplete, enableAnimation, speeds.typing, preventLayoutShift])
  ...
  function getUppercaseSVG(letter: string): string {
    const svgs: Record<string, string> = {
      a: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46 51" height="51" width="46">
      ...
      b: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 47 51" height="51" width="47">
      ...
      c: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 37 51" height="51" width="37">
      ...
      d: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 45 51" height="51" width="45">
      ...
      e: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46 51" height="51" width="46">
      ...
      f: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 60 51" height="51" width="60">
      ...
      g: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 51" height="51" width="40">
      ...
      h: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 51" height="51" width="54">
      ...
      i: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 49 51" height="51" width="49">
      ...
      j: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 53 51" height="51" width="53">
      ...
      k: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 59 51" height="51" width="59">
      ...
      l: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 51" height="51" width="30">
      ...
      m: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 49 51" height="51" width="49">
      ...
      n: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 45 51" height="51" width="45">
      ...
      o: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 34 51" height="51" width="34">
      ...
      p: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 52 51" height="51" width="52">
      ...
      q: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 41 51" height="51" width="41">
      ...
      r: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 58 51" height="51" width="58">
      ...
      s: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46 51" height="51" width="46">
      ...
      t: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 62 51" height="51" width="62">
      ...
      u: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 44 51" height="51" width="44">
      ...
      v: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 41 51" height="51" width="41">
      ...
      w: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 57 51" height="51" width="57">
      ...
      x: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 41 51" height="51" width="41">
      ...
      y: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 35 51" height="51" width="35">
      ...
      z: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 55 51" height="51" width="55">
    ...
    return svgs[letter] || `<svg width="15" height="25"><path d="M2 5L2 20"/></svg>`;
  }

  function getLowercaseSVG(letter: string): string {
    const svgs: Record<string, string> = {
  ...
  function applyLetterMargins(element: HTMLElement, letter: string, isUppercase: boolean) {
  ...
  return (
    <>
      ...
      {(colorScheme === 'gradient' || (colorScheme === 'custom' && colors.stroke === 'url(#signature-gradient)')) && (
      ...
      <div className={`signature-modal ${isActive ? "active" : ""} ${className}`}>
        ...
        <style jsx>{`
          .signature-modal {
            ...
            height: ${fixedHeight ? '220px' : (isActive || preventLayoutShift ? '220px' : '60px')};
            ...
            transition: ${preventLayoutShift || fixedHeight ? 'none' : '0.4s ease height, 0.4s ease padding, 0.2s border-radius, 0.6s ease box-shadow'};
        }
          ...
          .signature {
              border-bottom: 1px solid ${colors.borderActive || colors.border || 'rgba(0,0,0,0.25)'};
              padding-top: 10px;
          }
