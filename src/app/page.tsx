      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          <div className="text-center">
            {/* Badge */}
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-sage/10 text-sage text-sm font-medium mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Button
                size="lg"
                className="bg-sage hover:bg-sage/90 text-cream px-8 py-4 text-lg font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-200"
              >
                Start now
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-sage/20 text-sage hover:bg-sage/5 px-8 py-4 text-lg font-medium rounded-lg"
              >
                Contact sales
              </Button>
            </div>
          ...
          <div className="mt-20 relative">
            <div className="relative mx-auto max-w-5xl">
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-sage/10 overflow-hidden">
                <div className="bg-sage/5 px-6 py-4 border-b border-sage/10">
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-sage/5 rounded-lg">
                      ...
                      <div className="text-sm text-sage/60">2 min ago</div>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-sage/5 rounded-lg">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-sage rounded-lg flex items-center justify-center">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -left-4 w-20 h-20 bg-sage/10 rounded-full blur-xl"></div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-sage/5 rounded-full blur-2xl"></div>
            </div>
          </div>
        </div>
      </main>
